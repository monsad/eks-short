...
.. code-block:: shell
  ...
  vim ~/.ssh/bastion.service.schoolofrock.edu.pem
  sudo chmod 400 ~/.ssh/bastion.service.schoolofrock.edu.pem

  # 3.) connect to the bastion server via ssh
  ssh bastion.service.schoolofrock.edu -i ~/.ssh/bastion.service.schoolofrock.edu.pem
...
.. code-block:: shell
  ...
  mysql -h mysql.service.schoolofrock.edu -u root -p

  mongo --port 27017 --host mongo.service.schoolofrock.edu

  redis-cli -h redis.service.schoolofrock.edu -p 6379
